		...
		<div class="clearfix width100">
			<div class="col-md-12 column">
				<div class="sliderHolderS">					
					<?php $a = new GlobalArea ('home page slider 2');  $a->display($c); ?>
				</div>
            </div> <!-- sliderHolderS -->
        </div> <!-- row -->
    </div>
		...
		<div class="container">
			<div class="clearfix width100">
				<div class="col-md-4 column">					
					<?php $a = new GlobalArea ('reflect1 global 1.0');  $a->display($c); ?>
				</div>

				<div class="col-md-4 column">					
					<?php $a = new GlobalArea ('reflect1 global 1.1');  $a->display($c); ?>
				</div>

				<div class="col-md-4 column">					
					<?php $a = new GlobalArea ('reflect1 global 1.2');  $a->display($c); ?>
				</div>
			</div>
		</div>
	</div>
